...
namespace MetalTensors.Layers
{
    ...
    public class ConvTransposeLayer : ConvWeightsLayer
    {
        ...
        public ConvTransposeLayer (int inFeaureChannels, int outFeatureChannels, int sizeX, int sizeY, int strideX, int strideY, ConvPadding padding, bool bias, WeightsInit weightsInit, float biasInit, string? name = null, bool isTrainable = true)
            : base (inFeaureChannels, outFeatureChannels, sizeX, sizeY, strideX, strideY, padding, bias, weightsInit, biasInit, name: name, isTrainable: isTrainable)
        {
        }
